      ...
      return (
        <div className="space-y-5">
          <div className="rounded-[1.75rem] border border-white/10 bg-black/10 p-5 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08)]">
            ...
            <p className="mt-3 text-base text-gray-200 leading-7">
              Execute commands, inspect logs, or manage low-level OS services from the Aether command shell.
            </p>
          </div>
          <div className="rounded-[1.75rem] border border-white/10 bg-black/20 p-4 font-mono text-sm text-green-200 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.05)]">
            <p className="text-cyan-200">{'>'} system.status()</p>
            <p className="mt-3 text-gray-300">Aether Core: Online</p>
            <p className="mt-3 text-gray-300">Network: Secure</p>
            <p className="mt-3 text-gray-300">AI Interface: Stable</p>
            <p className="mt-3 text-gray-400">{'>'} _</p>
          </div>
        </div>
      );
